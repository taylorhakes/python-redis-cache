...
Arguments and return types must be JSON serializable by default. You can override the serializer, but be careful with using Pickle.  
Make sure you understand the security risks. [Pickle must not be used with untrusted values](https://security.stackexchange.com/questions/183966/safely-load-a-pickle-file), so make sure you secured access to your Redis instance.  
